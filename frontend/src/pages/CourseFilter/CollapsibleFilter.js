        ...
        <div className="courseContentFilter">
            ...
            <div className="contentCFilter" onClick={() => setIsOpen(!isOpen)}>
                <div className="iconCourseCFilter">
                    {!isOpen ? <p className="iconArrowDownFilter">Open</p> : <p className="iconArrowDownFilter">close</p>} <b>{props.title}</b>
                </div>
                        ...
                        <div className="sessionNameFilter">
                            {props.value == 1 ?
                                ...
                                <form onChange={handleRating} value={rating}>
                                    <input type="radio" name="rating" value={4.5} id="rate" /> <label for="rate"><span className="start"></span> 4.5 & up</label><br></br>
                                    <input type="radio" name="rating" value={4} id="rate1" /> <label for="rate1"><span className="start"></span> 4.0 & up</label><br></br>
                                    <input type="radio" name="rating" value={3.5} id="rate2" /> <label for="rate2"><span className="start"></span> 3.5 & up</label><br></br>
                                    <input type="radio" name="rating" value={3} id="rate3" /> <label for="rate3"><span className="start"></span> 3.0 & up</label><br></br>
                                </form>
