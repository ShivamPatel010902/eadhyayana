...
import { FaBookMedical, FaSearch, FaMinusCircle } from "react-icons/fa";
    ...
    <>
      <nav className="navbar">
        ...
        <div className="logo">
          <Link to="/">
            <img
              src="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/654e0b128095255.641921778c7d8.png"
              alt="Logo"
        ...
        {showicons && (
          <div className="Phoneonright">
            {showsearch ? (
              ...
              <FaSearch size={20} onClick={() => setshowsearch(!showsearch)} />
            )}
            <Link to="/cart">
              <Badge
